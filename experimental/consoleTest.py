...
def fit_console(width: int, height: int) -> Tuple[int, int]:
    ...
    tileset = libtcod.tileset.get_default()
    return width // tileset.tile_width, height // tileset.tile_height


def main() -> None:
    window_flags = (
        libtcod.lib.SDL_WINDOW_RESIZABLE | libtcod.lib.SDL_WINDOW_MAXIMIZED
    )
    renderer_flags = libtcod.lib.SDL_RENDERER_PRESENTVSYNC

    with custrender.init_sdl2(640, 480, 'Console Test', window_flags, renderer_flags):
        ...
        #libtcod.console_init_root(screen_width, screen_height, 'Roguelike Python Game', False)
        ...
        while not libtcod.console_is_window_closed():
            ...
            render_all(console, panel, entities, player, game_map, fov_map, fov_recompute, message_log,
